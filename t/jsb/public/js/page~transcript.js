...
const {
  getUrl: jsb_getUrl
} = __webpack_require__(/*! jsb/modules/_config/key */ "./src/js/modules/_config/key.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  keyInfo: keyInfo,
  //list, bmnet
  bm_modal_key: "bm.jsb.modal",
  //list
  bm_creation_state: "bm.jsb.creation",
  //bookmark
  bm_list_store: "bm.jsb.list",
  //bmnet
  bm_topic_list: "bm.jsb.topics",
  //bmnet
  bm_modal_store: "bm.jsb.modal",
  //navigator
...
const SOURCE_ID = "jsb";
const SOURCE = "The Impersonal Life"; //mp3 and audio timing base directories

const audioBase = `https://s3.amazonaws.com/${AWS_BUCKET}/${SOURCE_ID}/audio`;
const timingBase = "/t/jsb/public/timing"; //location of configuration files

const configUrl = "/t/jsb/public/config";
const configStore = "config.jsb."; //the current configuration, initially null, assigned by getConfig()
...
function getAudioInfo(url) {
  ...
  switch (idx[2]) {
    default:
      ...
      cIdx = parseInt(idx[3].substr(4), 10) - 1; //console.log("cIdx: %s", cIdx);
...
const status = {
  acq: "Mon Mar 18 14:23:19 WITA 2019",
  til: "Mon Mar 18 14:24:01 WITA 2019"
};
...
const uiModalOpacity = 0.5; //generate html for Contents
...
function pageDriver() {
  ...
  driver.defineSteps([cmiPageTitle, theImpersonalLife]);
  driver.start();
}
