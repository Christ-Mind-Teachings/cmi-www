...
function setLinks() {
  if (location.hostname === "localhost") {
    ...
    $("#acim-christmind-info").attr("href", `http://localhost:${_constants__WEBPACK_IMPORTED_MODULE_6__["default"].ports.acim}/`);
    $("#wom-christmind-info").attr("href", `http://localhost:${_constants__WEBPACK_IMPORTED_MODULE_6__["default"].ports.wom}/`);
    $("#raj-christmind-info").attr("href", `http://localhost:${_constants__WEBPACK_IMPORTED_MODULE_6__["default"].ports.raj}/`);
    $("#jsb-christmind-info").attr("href", `http://localhost:${_constants__WEBPACK_IMPORTED_MODULE_6__["default"].ports.jsb}/`);
...
$(document).ready(() => {
  ...
  _modules_about_about__WEBPACK_IMPORTED_MODULE_5__["default"].initialize(); //email mgt page
