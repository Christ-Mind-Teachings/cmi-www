...
const {
  getUrl: acol_getUrl
} = __webpack_require__(/*! acol/modules/_config/key */ "./src/js/modules/_config/key.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  keyInfo: keyInfo,
  //list, bmnet
  bm_modal_key: "bm.acol.modal",
  //list
  bm_creation_state: "bm.acol.creation",
  //bookmark
  bm_list_store: "bm.acol.list",
  //bmnet
  bm_topic_list: "bm.acol.topics",
  //bmnet
  bm_modal_store: "bm.acol.modal",
  //navigator
...
const SOURCE_ID = "acol";
const SOURCE = "A Course Of Love"; //mp3 and audio timing base directories

const audioBase = `https://s3.amazonaws.com/${AWS_BUCKET}/${SOURCE_ID}/audio`;
const timingBase = "/t/acol/public/timing"; //location of configuration files

const configUrl = "/t/acol/public/config";
const configStore = "config.acol."; //the current configuration, initially null, assigned by getConfig()
...
const status = {
  acq: "Wed Nov 6 10:59:52 HST 2019",
  course: "Wed Jan 1 21:43:55 HST 2020",
  treatise: "Mon Dec 23 11:03:23 HST 2019",
  dialog: "Wed Dec 25 12:39:00 HST 2019"
};
...
function nextPrevRestricted(toc, $el) {
  ...
  let prevId = -1,
      nextId = -1,
      href,
      text; //get next/prev from unrestricted units

  let np = getNextPrevRestrictedUnitId($el, LAST_ID); //disable prev control
...
function loadTOC(toc) {
  ...
  Object(_config_config__WEBPACK_IMPORTED_MODULE_1__["getConfig"])(book).then(contents => {
    ...
    toc.init = true; //default version of toc render function
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  initialize: function (env) {
    ...
    const userInfo = Object(www_modules_user_netlify__WEBPACK_IMPORTED_MODULE_3__["getUserInfo"])();
    ...
    $(uiOpenTocModal).on("click", e => {
      ...
      if (env !== "transcript" || env === "transcript" && combined) {
        Object(_config_config__WEBPACK_IMPORTED_MODULE_1__["getConfig"])(book).then(contents => {
          $(".toc-image").attr("src", `${contents.image}`);
          $(".toc-title").html(`Table of Contents: <em>${contents.title}</em>`);
          $(".toc-list").html(makeContents(contents.base, contents.contents, contents.bid, toc)); //mark toc as combined
...
/* harmony import */ var www_modules_user_netlify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! www/modules/_user/netlify */ "../cmi-www/src/js/modules/_user/netlify.js");
/* harmony import */ var _navigator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./navigator */ "./src/js/modules/_search/navigator.js");
/* harmony import */ var toastr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! toastr */ "./node_modules/toastr/toastr.js");
/* harmony import */ var toastr__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(toastr__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var www_modules_audit_audit__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! www/modules/_audit/audit */ "../cmi-www/src/js/modules/_audit/audit.js");
...
function displaySearchMessage(msgId, arg1, arg2, arg3, arg4) {
  switch (msgId) {
    ...
    case SEARCH_RESULT:
      ...
      $(uiSearchMessageHeader).text("Search Result"); //arg4 is number of hits not returned because user not authorized to view all ACOL content
...
function search(query) {
  let user = Object(www_modules_user_netlify__WEBPACK_IMPORTED_MODULE_3__["getUserInfo"])();
  let searchBody = {
    query: query,
    width: 30,
    authorization: "guest"
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(searchEndpoint, searchBody).then(response => {
    ...
    if (response.data.count - response.data.restricted > 0) {
      ...
      toastr__WEBPACK_IMPORTED_MODULE_5___default.a.info(`Search for ${query} didn't find any matches`);
    }

    Object(www_modules_audit_audit__WEBPACK_IMPORTED_MODULE_6__["searchAudit"])("ACOL", searchBody.query, response.data.count);
    document.getElementById("search-input-field").focus();
  }).catch(error => {
    console.error("search error: %o", error);
    displaySearchMessage(SEARCH_ERROR, error.message);
    Object(www_modules_audit_audit__WEBPACK_IMPORTED_MODULE_6__["searchAudit"])("ACOL", searchBody.query, 0, error.message);
  });
}
...
function initTranscriptPage() {
  ...
  if (displayPid) {
    Object(_navigator__WEBPACK_IMPORTED_MODULE_4__["initNavigator"])(displayPid);
  }
}
/*
