...
const {
  getUrl: wom_getUrl
} = __webpack_require__(/*! wom/modules/_config/key */ "./src/js/modules/_config/key.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  keyInfo: keyInfo,
  //list, bmnet
  bm_modal_key: "bm.wom.modal",
  //list
  bm_creation_state: "bm.wom.creation",
  //bookmark
  bm_list_store: "bm.wom.list",
  //bmnet
  bm_topic_list: "bm.wom.topics",
  //bmnet
  bm_modal_store: "bm.wom.modal",
  //navigator
...
const transcript = __webpack_require__(/*! ./key */ "./src/js/modules/_config/key.js"); //mp3 and audio timing base directories


const audioBase = "https://s3.amazonaws.com/assets.christmind.info/wom/audio";
const timingBase = "/t/wom/public/timing";
const SOURCE = "The Way of Mastery"; //location of configuration files

const configUrl = "/t/wom/public/config";
const configStore = "config.wom."; //the current configuration, initially null, assigned by getConfig()
...
function getAudioInfo(url) {
  ...
  switch (idx[2]) {
    ...
    case "wos":
      cIdx = lodash_indexOf__WEBPACK_IMPORTED_MODULE_2___default()(wos, idx[3]);
      audioInfo = _getAudioInfo(idx, cIdx);
      break;

    case "early":
      cIdx = lodash_indexOf__WEBPACK_IMPORTED_MODULE_2___default()(lookup, idx[3]);
      audioInfo = _getAudioInfo(idx, cIdx);
      break;
...
const status = {
  acq: "Tue Apr 2 22:13:21 HST 2019",
  early: "Thu Dec 26 21:28:01 HST 2019",
  tjl: "Thu Dec 26 21:27:53 HST 2019",
  woh: "Thu Dec 26 21:05:52 HST 2019",
  wok: "Thu Dec 26 21:06:09 HST 2019",
  wos: "Thu Dec 26 21:27:44 HST 2019",
  wot: "Thu Dec 26 21:06:01 HST 2019"
};
