...
module.exports = {
  ...
  sid: "col",
  prefix: "/t/col",
  books: ["book1", "book2", "book3", "book4", "acq"],
  bookIds: ["xxx", "book1", "book2", "book3", "book4", "acq"],
  contents: {
...
function highlightParagraph(pid, rangeStart, rangeEnd, creationDate) {
  ...
  $(".topic-navigator").removeClass("topic-navigator navigator-highlight navigator-highlight-top navigator-highlight-bottom navigator-highlight-middle"); // annotation has 1 paragraph
