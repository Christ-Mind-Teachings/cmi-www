...
const bm_topic_list = "bm.acol.topics"; //Index topics
...
function formatNewTopics({
  ...
  newTopicArray = newTopicArray.map(t => lodash_startCase__WEBPACK_IMPORTED_MODULE_4___default()(t)); //3. Format topics into object
...
function initClickListeners() {
  ...
  $(".bookmark-navigator").on("click", ".annotation-item", function (e) {
    ...
    if (annotation_id !== "undefined") {
      ...
      console.log("Sharing highlighted text annotation: id=%s, aid=%s", annotation_id, aid);
    } else {
      //this is a note level bookmark, get aid from the pid
      aid = $(`#${pid} > span.pnum`).attr("data-aid");
      console.log("Sharing note style annotation: id=undefined, aid=%s", aid);
    }
...
const SOURCE_ID = "acol"; //mp3 and audio timing base directories
...
const sourceId = 14; //length of pageKey excluding decimal portion
...
const status = {
  course: "Mon Mar 18 13:35:08 WITA 2019",
  treatise: "Mon Mar 18 13:35:26 WITA 2019",
  dialog: "Mon Mar 18 13:35:18 WITA 2019"
};
