...
const bm_topic_list = "bm.jsb.topics"; //Index topics
...
const bm_creation_state = "bm.jsb.creation"; //add bookmark topics to bookmark selected text to support 
...
const SOURCE_ID = "jsb"; //mp3 and audio timing base directories
